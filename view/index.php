        ...
        <main>
            ...
            <div>
                <section class="estilo-bikes">
                    <div class="container-estilo-bikes">
                        <h2 class="titulo-cards">Escolha seu estilo</h2>
            ...
            <section class="secao-contato" id="secao-contato">
                ...
                <div class="dados-contatos">
                    <h2>Contato</h2>
                    <span class="dados-contatos-item">
                        <ion-icon name="location" class="icone-secao-contato"></ion-icon>
                        <p>R. Mata Bacelar, 772 - Loja 102 - Auxiliadora, Porto Alegre</p>
                    </span>
                    <span class="dados-contatos-item">
                        <ion-icon name="call" class="icone-secao-contato"></ion-icon>
                        <p>51 3777.3037</p>
                    </span>
                    <span class="horario-atendimento dados-contatos-item">
                        <ion-icon name="time" class="icone-secao-contato"></ion-icon>
